    ...
    public class PROTOCOL_BATTLE_GIVEUPBATTLE_REQ : ReceivePacket
    {
        ...
        public override void run()
        {
            try
            {
                ...
                Slot slot;
                if (room != null && room._state >= RoomState.Loading && room.getSlot(p._slotId, out slot) && (int)slot.state >= 10)
                {
                    ...
                    if (slot._id == room._leader)
                    {
                        ...
                        else if (room._state == RoomState.Battle && (red13 == 0 || blue13 == 0) || room._state <= RoomState.PreBattle && (red9 == 0 || blue9 == 0))
                        {
                    ...
                    {
                        if (room._state == RoomState.Battle && (red13 == 0 || blue13 == 0) || room._state <= RoomState.PreBattle && (red9 == 0 || blue9 == 0))
                        {
        ...
        private void FreepassEffect(Account p, Slot slot, Room room, bool isBotMode)
        {
            ...
            else// if (ch._type != 4)
            {
                ...
                else
                {
                    ...
                    if (room.room_type == RoomType.Bomb || room.room_type == RoomType.FreeForAll || room.room_type == RoomType.Convoy) // New Mode
                    {
